		...
		var map; 
		var zoom=16;
		var TeaAddress="浙江省绍兴市富盛镇御茶村"
        var Tealocation=[120.696275,29.93778333]
        var Teacomanyname="绍兴市御茶村茶业有限公司"
        if(teaname==ycc)
        {
            zoom=16;
            TeaAddress="浙江省绍兴市富盛镇御茶村"
            Tealocation=[120.696275,29.93778333]
            Teacomanyname="绍兴市御茶村茶业有限公司"
        }else{
            if(teaname==fht)
            {
                zoom=16;
                TeaAddress="浙江省杭州市双浦镇双灵村"
                Tealocation=[120.0167583,30.13109167]
                Teacomanyname="杭州福海堂茶业有限公司"
            }else{
                if(teaname==qs)
                {
                    zoom=16;
                    TeaAddress="浙江省杭州市龙坞镇长埭村"
                    Tealocation=[120.0351056,30.17056944]
                    Teacomanyname="杭州求是茶叶有限公司"
                }else{
                    if(teaname==ts)
                    {
                        zoom=16;
                        TeaAddress="温州市泰顺县司前镇溪口村"
                        Tealocation=[119.7309472,27.56337222]
                        Teacomanyname="泰顺灵狐农业试验场"
                    }else{
                        if(teaname==bxc)
                        {
                            zoom=16;
                            TeaAddress="泰安市岱岳区山口镇小马庄村"
                            Tealocation=[117.2427056,36.23409444]
                            Teacomanyname="泰安市泰山碧霞春经贸有限公司"
                        }else{
                            zoom=16;
                            TeaAddress="浙江省绍兴市富盛镇御茶村"
                            Tealocation=[120.696275,29.93778333]
